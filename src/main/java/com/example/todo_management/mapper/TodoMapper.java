...
public interface TodoMapper {
    ...
    @Insert("INSERT INTO todos (priority, task, deadline, category, start_time, end_time, place, memo, user_id) VALUES (#{priority}, #{task}, #{deadline}, #{category}, #{startTime}, #{endTime}, #{place}, #{memo}, #{userId})")
    ...
    @Update("UPDATE todos SET priority = #{priority}, task = #{task}, deadline = #{deadline}, category = #{category}, start_time = #{startTime}, end_time = #{endTime}, place = #{place}, memo = #{memo} WHERE id = #{id}")
